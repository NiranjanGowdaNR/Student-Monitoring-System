      ...
      <section id='About'>
        ...
        <div className="section-container">
          ...
          <div className='about-text'>
            <p>
              "Enthusiastic student proficient in web development, with a strong foundation in Data Structures and Algorithms (DSA). Exceptional communication skills complement technical prowess. Eager to contribute effectively in a dynamic team environment while continuously enhancing expertise."
            </p>
          </div>
        </div>
      </section>
        ...
        <FooterContainer sx={{ backgroundColor: '#FFFFFF' }}>
          ...
          <Box display="flex" justifyContent="space-between" alignItems="center" borderTop="1px solid #ddd" py={3} mt={3}>
            ...
            <ul className="list-unstyled d-flex">
              ...
              <li className="ms-3"><a className="link-body-emphasis" href="https://www.instagram.com "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-instagram" viewBox="0 0 16 16">
              ...
              <li className="ms-3"><a className="link-body-emphasis" href="https://www.facebook.com "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-facebook" viewBox="0 0 16 16">
